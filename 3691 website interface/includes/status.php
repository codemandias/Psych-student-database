                ...
                <div class = "contentLeft">
                    <h3>Student Information</h3>
                        ...
                        <label for="studentEmail">*Student Email: </label>
                            ...
                            <hr style="width:310%;"></hr>

                    <section class="milestone">
                        <div class="MScStatus">
                            <h3>MSc</h3>
                            <label for="MScDetails">MSc Defense: </label>
                            <input type="date" id="mscDefense" name="mscDefenseDate" value="- -" min="2000-01-01" required><br><br>
                            <label for="MScDetails">Consider for thesis award: </label>
                            <input type="date" id="thesisAward" name="thesisAward" value="- -" min="2000-01-01" required><br><br>
                        ...
                        <div class="PhDStatus">
                            ...
                            <input type="date" id="phdDefense" name="phdDefenseDate" value="- -" min="2000-01-01" required><br><br>
                            ...
                            <input type="date" id="mscConvocation" name="mscConvocationDate" value="- -" min="2000-01-01" required><br><br>
                            <label for="PhDDetails">Intership start: </label>
                            <input type="date" id="internship" name="internshipDate" value="- -" min="2000-01-01" required><br><br>
                    ...
                    <label for="term">Require to TA: </label>
                        <input type="radio" id="requireTAYes" name="requireTA" value="yes"> <label for="requireTAYesLabel"> Yes</label>
                        <input type="radio" id="requireTANO" name="requireTA" value="no"><label for="requireTANoLabel"> No</label><br><br>
