...
<div id="content">
    <div class="contentLeft">
        ...
        <form method="get" action="">
            ...
            <input type="radio" id="PhD" name="degree" value="PhD"><label for="degreeLabel"> PhD(Includes clinical
                MSc/PhD fast-track)</label><br><br>
    ...
    <div class="contentRight">
        ...
        <p>(*) marks fields that are used to calculate finances, it is critical the information is complete and
            accurate</p>
