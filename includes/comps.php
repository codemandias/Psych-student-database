...
<form method="get" action="">
    <div class="content">
        <div class="contentLeft">
            ...
            <input type="date" id="supervisor1_appro_date" name="supervisor1_appro_date" value="- -"
                   min="2000-01-01"><br>
            ...
            <input type="date" id="supervisor1_complete_date" name="supervisor1_complete_date" value="- -"
            ...
            <label for="CompsDetails">Approved date(MM/DD/YYYY): </label>
            <input type="date" id="supervisor2_appro_date" name="supervisor2_appro_date" value="- -"
                   min="2000-01-01"><br>
            <label for="CompsDetails">Internal(First/Last): </label>
            <input type="text" id="internal2_first" name="internal2_first">
            <input type="text" id="internal2_last" name="internal2_last">
            <label for="CompsDetails">*Completed date(MM/DD/YYYY): </label>
            <input type="date" id="supervisor2_complete_date" name="supervisor2_complete_date" value="- -"
                   min="2000-01-01" required><br>
            ...
            <label for="CompsDetails">Approved date(MM/DD/YYYY): </label>
            <input type="date" id="supervisor3_appro_date" name="supervisor3_appro_date" value="- -"
                   min="2000-01-01"><br>
            <label for="CompsDetails">Internal(First/Last): </label>
            <input type="text" id="internal3_first" name="internal3_first">
            <input type="text" id="internal3_last" name="internal3_last">
            <label for="CompsDetails">*Completed date(MM/DD/YYYY): </label>
            <input type="date" id="supervisor3_complete_date" name="supervisor3_complete_date" value="- -"
                   min="2000-01-01" required><br><br>
