    ...
    <div class="content">
        <div class="contentLeft">
            ...
            <p id="row">
                ...
                ?>
                <label for="StatusDetails"> </label>
                <?php
                echo '<input type="text" id="LnameField" value="'.$_SESSION['student'][1].'"></input>'; 
                ?><br><br>
                <label for="sInfo"> *ID: </label>
                <?php
                echo '<input type="text" id="S_ID" name="studentID" value="'.$_SESSION['student'][2].'"></input>'; 
                ?>
            </p>
            <label for="AwardDetails">*Degree: </label>
            <?php if($_SESSION['student'][3]=="MSc")
            ...
            ?>
            <label for="AwardDetails">*Program: </label>
            <?php 
            ...
            <?php
                echo '<input type="text" id="emailField" name="supervisorFName" required value="'.$_SESSION['student'][6].'"></input>'; 
            ?>
            <label for="supervisorLName"> </label>
            <?php
                echo '<input type="text" id="emailField" name="supervisorLName" required value="'.$_SESSION['student'][7].'"></input>'; 
            ?>
            <br><br>
            <label for="studentEmail">*Student Email: </label>
            <?php
                echo '<input type="text" id="emailField" name="email" required value="'.$_SESSION['student'][8].'"></input>'; 
            ?>
            <br><br>
            <hr style="width: 166%">
