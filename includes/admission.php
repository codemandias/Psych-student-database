           ...
           <h3>Student Information</h3>
             <p id="row">
                ...
                if(!isset($_SESSION['student'])){
                    echo '<input type="text" id="nameField" name="admissionFirstName">
                          <label for="studentDetails"> </label><input type="text" id="LnameField" name="admissionLastName"><br><br></p>
                          <p id="row"><label for="sInfo"> *ID: </label><input type="text" id="S_ID" name="admissionStudentID"><br><br></p>
                          <label for="studentDetails">*Degree: </label><input type="radio" id="MSc" name="admissionDegree" value="MSc"> <label for="degreeLabel"> MSc</label>
                          <input type="radio" id="PhD" name="admissionDegree" value="PhD"><label for="degreeLabel"> PhD(Includes clinical MSc/PhD fast-track)</label><br><br><label for="studentDetails">*Program: </label></label>
                          ...
                          <label for="studentSupervisor">*Supervisor(F/L): </label><select name="studentSalutations" id="admissionSalutations">
                          <option value="mr">Mr.</option><option value="miss">Miss</option>
                          </select><label for="supervisorFName"> </label><input type="text" id="admissionSupervisorFName" name="admissionSupervisorFName">
                          <label for="supervisorLName"> </label><input type="text" id="admissionSupervisorLName" name="admissionSupervisorLName"><br><br>
                          <label for="studentEmail">*Student Email: </label><input type="text" id="admissionStudentEmail" name="admissionStudentEmail">';
                }
